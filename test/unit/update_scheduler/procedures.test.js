...
describe('TR-069 Update Scheduler Tests - Functions', () => {
  ...
  describe('markNextForUpdate', () => {
    ...
    test('Aborted', async () => {
      ...
      expect(consoleSpy)
        .toHaveBeenLastCalledWith('Scheduler: Schedule aborted');
    });
    ...
    // No online devices 1
    test('No online devices 1', async () => {
      // Set fake timers
      jest.useFakeTimers();
    ...
    // No online devices 2
    test('No online devices 2', async () => {
      // Set fake timers
      jest.useFakeTimers();
    ...
    // Flashbox same firmware
    test('Flashbox same firmware', async () => {
      // Set fake timers
      jest.useFakeTimers();
    ...
    // TR069 same firmware
    test('TR069 same firmware', async () => {
      // Set fake timers
      jest.useFakeTimers();
      jest.useFakeTimers('modern').setSystemTime(
        // Year, Month, Day, Hour, Minute, Seconds
  ...
  describe('initialize', () => {
    ...
    test('Null config', async () => {
      ...
      // Spies
      const watchdogSpy = jest.spyOn(SchedulerCommon, 'scheduleOfflineWatchdog')
      ...
      expect(watchdogSpy).not.toBeCalled();
    });
    ...
    test('Okay', async () => {
      ...
      expect(watchdogSpy).toBeCalled();
    });
  });


  // markSeveral
  describe('markSeveral', () => {
    // Null config
    test('Null config', async () => {
      // Mocks
      utils.common.mockConfigs(null, 'findOne');
  ...
  describe('timeout', () => {
    ...
    test('Scheduler not active', async () => {
      // Copy config
    ...
    invalidTimeoutPeriods.forEach((timeoutPeriod) => {
      test('Invalid period: ' + timeoutPeriod, async () => {
        // Copy config
        let model = models.copyConfigFrom(
          '62b9f57c6beaae3b4f9d4656',
          {
    ...
    // No timed out device
    test('No timed out device', async () => {
      // Set fake timers
      jest.useFakeTimers();
      jest.useFakeTimers('modern').setSystemTime(
        // Year, Month, Day, Hour, Minute, Seconds
    ...
    // Single timed out device not updating
    test('Single timed out device not updating', async () => {
      // Set fake timers
      jest.useFakeTimers();
      jest.useFakeTimers('modern').setSystemTime(
        // Year, Month, Day, Hour, Minute, Seconds
        new Date(2023, 8, 8, 15, 43, 32),
      );

      // Assing an old date, to be the timed out device
      let oldDate = new Date(2023, 1, 8, 15, 43, 32);

      // Assing a new date, to not be timed out
    ...
    // Single timed out device errored
    test('Single timed out device errored', async () => {
      // Set fake timers
      jest.useFakeTimers();
      jest.useFakeTimers('modern').setSystemTime(
        // Year, Month, Day, Hour, Minute, Seconds
    ...
    // Single timed out RG 1200 new firwmare
    test('Single timed out RG 1200 new firwmare', async () => {
      // Set fake timers
      jest.useFakeTimers();
      jest.useFakeTimers('modern').setSystemTime(
        // Year, Month, Day, Hour, Minute, Seconds
    ...
    // Single timed out RG 1200 old firwmare
    test('Single timed out RG 1200 old firwmare', async () => {
      // Set fake timers
      jest.useFakeTimers();
      jest.useFakeTimers('modern').setSystemTime(
        // Year, Month, Day, Hour, Minute, Seconds
    ...
    // Multiple timed out RG 1200 old firwmare
    test('Multiple timed out RG 1200 old fw', async () => {
      // Set fake timers
      jest.useFakeTimers();
      jest.useFakeTimers('modern').setSystemTime(
        // Year, Month, Day, Hour, Minute, Seconds
    ...
    // All timed out RG 1200 old firwmare
    test('All timed out RG 1200 old fw', async () => {
      // Set fake timers
      jest.useFakeTimers();
      jest.useFakeTimers('modern').setSystemTime(
        // Year, Month, Day, Hour, Minute, Seconds
    ...
    // Single timed out tr069 no acs_id
    test('Single timed out tr069 no acs_id', async () => {
      // Set fake timers
      jest.useFakeTimers();
      jest.useFakeTimers('modern').setSystemTime(
        // Year, Month, Day, Hour, Minute, Seconds
    ...
    // Single timed out tr069
    test('Single timed out tr069', async () => {
      // Set fake timers
      jest.useFakeTimers();
      jest.useFakeTimers('modern').setSystemTime(
        // Year, Month, Day, Hour, Minute, Seconds
    ...
    // Single timed out tr069 no device
    test('Single timed out tr069 no device', async () => {
      // Set fake timers
      jest.useFakeTimers();
      jest.useFakeTimers('modern').setSystemTime(
        // Year, Month, Day, Hour, Minute, Seconds
    ...
    // Scheduler finished but still active
    test('Scheduler finished but still active', async () => {
      // Set fake timers
      jest.useFakeTimers();
      jest.useFakeTimers('modern').setSystemTime(
        // Year, Month, Day, Hour, Minute, Seconds
