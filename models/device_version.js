...
const convertTR069Permissions = function(cpePermissions) {
  let permissions = {
    ...
    grantLanDnsEdit: cpePermissions.lan.dnsServersWrite,
    grantLanDnsLimit: cpePermissions.lan.dnsServersLimit,
    ...
    grantBlockDevices: cpePermissions.features.macAccessControl ||
      cpePermissions.features.wlanAccessControl,
