...
const textSearchFields = [
  ...
  'wifi_bssid', 'wifi_password',
  'wifi_ssid_5ghz',
  'wifi_bssid_5ghz', 'wifi_password_5ghz',
  'app_password', 'lan_subnet', 'lan_dns_servers',
  'mesh_master', 'mesh_id', 'mesh_key', 'bssid_mesh2', 'bssid_mesh5',
  'mesh_father', 'bridge_mode_ip', 'bridge_mode_gateway', 'bridge_mode_dns',
  'wan_ip', 'wan_ipv6', 'ip',
  'ntp_status', 'mesh_next_to_update', 'mqtt_secret', 'pending_app_secret',
  'forward_index', 'blocked_devices_index', 'upnp_devices_index',
  'default_gateway_v4', 'default_gateway_v6', 'dns_server', 'pppoe_mac',
  'pppoe_ip', 'prefix_delegation_addr', 'prefix_delegation_mask',
