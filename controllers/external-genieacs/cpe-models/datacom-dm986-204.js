...
datacomModel.getModelFields = function() {
  ...
  fields.wan.vlan = 'InternetGatewayDevice.WANDevice.1.WANConnectionDevice.1.WANPPPConnectionNumberOfEntries'
  ...
  fields.devices.host_layer2 = 'InternetGatewayDevice.LANDevice.1.Hosts.Host.1.InterfaceType'
  return fields;
};
