...
const getTPLinkFields = function(model) {
  ...
  fields.wan_ip = fields.wan_ip.replace(/WANIPConnection\.1/g, 'WANIPConnection.2');
  fields.uptime = fields.uptime.replace(/WANIPConnection\.1/g, 'WANIPConnection.2');
  fields.mtu = fields.mtu.replace(/WANIPConnection\.\*/g, 'WANIPConnection.2');
