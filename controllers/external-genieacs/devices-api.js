...
const getTPLinkFields = function(model) {
  ...
  fields.wan.wan_ip = fields.wan.wan_ip.replace(/WANIPConnection\.1/g, 'WANIPConnection.2');
  fields.wan.uptime = fields.wan.uptime.replace(/WANIPConnection\.1/g, 'WANIPConnection.2');
  fields.wan.mtu = fields.wan.mtu.replace(/WANIPConnection\.\*/g, 'WANIPConnection.2');
