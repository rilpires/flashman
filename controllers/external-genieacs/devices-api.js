...
const getZTEFields = function() {
  ...
  fields.wan.pon_status = fields.wan.pon_status.replace(/WANGponInterfaceConfig.Status/g, 'X_ZTE-COM_WANPONInterfaceConfig.Status');
  fields.wan.pon_status = fields.wan.pon_status.replace(/WANGponInterfaceConfig.RXPower/g, 'X_ZTE-COM_WANPONInterfaceConfig.RXPower');
  fields.wan.pon_status = fields.wan.pon_status.replace(/WANGponInterfaceConfig.TXPower/g, 'X_ZTE-COM_WANPONInterfaceConfig.TXPower');
