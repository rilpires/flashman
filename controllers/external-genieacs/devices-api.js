...
const getHuaweiFields = function(model) {
  ...
  switch (model) {
    ...
    case 'EG8145V5': // Huawei EG8145V5
      ...
      fields.port_mapping_fields.external_port_start[0] = 'InternalPort';
      fields.port_mapping_fields.external_port_end = ['X_HW_InternalEndPort', 'external_port_end', 'xsd:unsignedInt'];
