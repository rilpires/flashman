...
meshHandlers.buildTR069Changes = function(device, targetMode) {
  ...
  switch (targetMode) {
    ...
    case 2:
      ...
      changes.mesh2.mode = DevicesAPI.convertWifiMode(device.wifi_mode, splitID[0], splitID[1]);
    ...
    case 3:
      ...
      changes.mesh5.mode = DevicesAPI.convertWifiMode(device.wifi_mode_5ghz, splitID[0], splitID[1]);
